...
async def create_file_from_url(url, filename="image.png", cache_dir="cache"):
    ...
    cached_file_path = cache_path / f"{file_id}{file_extension}"
    
    if cached_file_path.exists():
        return discord.File(cached_file_path, filename=filename)
